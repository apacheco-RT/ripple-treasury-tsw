          ...
          <motion.div ref={dialogRef}
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button autoFocus onClick={onConfirm}
                className="px-6 h-[var(--m3-button-height)] rounded-[var(--m3-shape-full)] bg-amber-500 hover:bg-amber-400 text-white font-medium text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 focus:ring-offset-surface-card">
                Place on Hold
              </button>
            </div>
          </motion.div>
