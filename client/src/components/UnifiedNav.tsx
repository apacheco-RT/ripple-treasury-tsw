  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-header">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden border-t border-[var(--ds-color-border-default)]/50 bg-[var(--ds-color-surface-page)]/95 backdrop-blur-md">
            ...
            >
              <div className="flex items-center justify-between p-6 border-b border-[var(--ds-color-border-default)]">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-[var(--ds-radius-lg)] bg-linear-to-br from-purple-600 to-purple-800 flex items-center justify-center">
