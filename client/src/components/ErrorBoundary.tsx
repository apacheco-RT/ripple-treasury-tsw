        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-surface-page">
          <div className="w-full max-w-md mx-4 bg-surface-card rounded-(--m3-shape-xl) border border-slate-800 p-(--m3-dialog-padding) text-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-(--m3-button-padding-h) h-(--m3-button-height) rounded-(--m3-shape-full) bg-teal-600 hover:bg-teal-500 text-white font-medium text-sm transition-all cursor-pointer"
            >
              Reload Page
            </button>
          </div>
