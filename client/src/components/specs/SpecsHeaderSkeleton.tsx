  ...
  return (
    <section className="pt-28 pb-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl">
        <Skeleton width="150px" height="28px" className="rounded-[var(--m3-shape-full)] mb-4" />
        ...
        <div className="bg-slate-800/40 border border-surface-border rounded-[var(--m3-shape-md)] p-[var(--m3-card-padding)] max-w-4xl mb-10">
        ...
        <div className="flex flex-wrap gap-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <Skeleton
              ...
              width={`${100 + i * 20}px`}
              height="30px"
              className="rounded-[var(--m3-shape-sm)]"
            />
          ))}
        </div>
      </div>
