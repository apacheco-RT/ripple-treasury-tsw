  ...
  return (
    <div className="p-4 flex flex-col gap-4 overflow-y-auto max-h-[360px]"
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button onClick={() => onAction(selectedTxn.id)}
          className="flex items-center gap-1.5 px-4 h-10 rounded-full text-xs font-medium bg-rose-500/20 hover:bg-rose-500/30 text-rose-300 border border-rose-500/30 transition-colors focus:outline-hidden focus:ring-2 focus:ring-rose-400 focus:ring-offset-1 focus:ring-offset-transparent">
          <X className="w-3.5 h-3.5" aria-hidden="true" /> Reject
        </button>
        <button onClick={() => onAction(selectedTxn.id)}
          className="flex items-center gap-1.5 px-4 h-10 rounded-full text-xs font-medium bg-transparent hover:bg-rose-500/15 text-rose-400 border border-rose-500/40 transition-colors focus:outline-hidden focus:ring-2 focus:ring-rose-400 focus:ring-offset-1 focus:ring-offset-transparent">
          <Ban className="w-3.5 h-3.5" aria-hidden="true" /> Void
        </button>
        <button
          onClick={() => onOverride(selectedTxn)}
          className="flex-1 flex items-center justify-center gap-1.5 px-6 h-10 rounded-full text-xs font-medium text-white transition-all hover:brightness-110 focus:outline-hidden focus:ring-2 focus:ring-rose-400 focus:ring-offset-1 focus:ring-offset-transparent"
