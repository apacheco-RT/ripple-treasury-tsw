    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-2 mb-2">
        <button disabled={avS === "loading"} onClick={() => onRunAV(pn)}
          className={`flex items-center gap-2 px-3 py-2.5 rounded-[var(--m3-shape-sm)] border text-left transition-all focus:outline-none focus:ring-2 focus:ring-teal-400 disabled:opacity-50
      ...
      {avS === "loading" && avSt.length > 0 && (
        <div className="rounded-[var(--m3-shape-sm)] border border-slate-700/60 bg-surface-page px-3 py-2.5 mb-2">
      ...
      {avS === "done" && avRes && (
        <div className={`rounded-[var(--m3-shape-sm)] border px-3 py-2.5 mb-2 text-xs ${avRes.status === "pass" ? "border-emerald-500/30 bg-emerald-500/8" : avRes.status === "warning" ? "border-amber-500/30 bg-amber-500/8" : "border-rose-500/30 bg-rose-500/8"}`}>
      ...
      {kybS === "done" && kybRes && (
        <div className={`rounded-[var(--m3-shape-sm)] border px-3 py-2.5 mb-2 text-xs ${kybRes.risk === "low" ? "border-emerald-500/30 bg-emerald-500/8" : kybRes.risk === "medium" ? "border-amber-500/30 bg-amber-500/8" : "border-rose-500/30 bg-rose-500/8"}`}>
          <div className="flex items-center justify-between mb-1.5">
