              ...
              <button
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-slate-200">1–5 business days</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2 text-slate-400"><FileText className="w-3.5 h-3.5" /> Cost</div>
                    <span className="font-medium text-slate-200">$25–45 / txn</span>
                  </div>
                </div>
                <div className="border-t border-surface-border pt-3 space-y-1.5">
                  {["Traditional banking infrastructure", "Established processes", "Wide acceptance"].map(f => (
                    <div key={f} className="flex items-center gap-2 text-xs text-slate-400">
                      <CheckCircle2 className="w-3.5 h-3.5 text-slate-400 shrink-0" aria-hidden="true" /> {f}
                    </div>
                  ))}
                </div>
              </button>
            ...
            {quoteGenerated && selectedRail === "stablecoin" && (
              <div className="px-6 pb-4 space-y-4">
                <div className="rounded-(--m3-shape-md) border-2 border-teal-500/40 bg-teal-500/5 p-5">
                  ...
                  <p className="mt-4 pt-3 border-t border-teal-500/20 text-xs text-slate-400">
