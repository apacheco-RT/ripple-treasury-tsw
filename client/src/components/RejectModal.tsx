          ...
          <motion.div ref={dialogRef}
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button autoFocus onClick={onConfirm}
                className="px-6 h-(--m3-button-height) rounded-(--m3-shape-full) bg-rose-500 hover:bg-rose-400 text-white font-medium text-sm transition-colors focus:outline-hidden focus:ring-2 focus:ring-rose-400 focus:ring-offset-2 focus:ring-offset-surface-card">
                Reject payments
              </button>
            </div>
          </motion.div>
